...
<template>
  ...
  <div>
    <span>Letters and Sounds <AudioPlayer src="../assets/01-IntroductoryLesson.mp3" buttonText="1" /></span>
  </div>

  <h2>Lesson 1</h2>
  
  <div>
    <span>Γειά σας <AudioPlayer src="../assets/02-Lesson1-1.mp3" buttonText="2" /></span>
    <span>Πώς σας λένε; <AudioPlayer src="../assets/03-Lesson1-2.mp3" buttonText="3" /></span>
    <span>Γειά σου <AudioPlayer src="../assets/04-Lesson1-3.mp3" buttonText="4" /></span>
    <span>Πώς σε λένε; <AudioPlayer src="../assets/05-Lesson1-4.mp3" buttonText="5" /></span>
  ...
  <div>
    <span>Από την Ισπανία στην Ελλάδα <AudioPlayer src="../assets/24-Lesson6.mp3" buttonText="24" /></span>
  </div>

  <h2>Lesson 7</h2>

  <div>
    <span>Πόσο κάνει αυτό το ρολόι; <AudioPlayer src="../assets/25-Lesson7-1.mp3" buttonText="25" /></span>    
  </div>

  <div>
    <span>Exercise 12 <AudioPlayer src="../assets/26-Lesson7-2.mp3" buttonText="26" /></span>
  </div>

  <h2>Lesson 8</h2>

  <div>
    <span>Ποιος είναι αυτός; <AudioPlayer src="../assets/27-Lesson8-1.mp3" buttonText="27" /></span>
    <span>Ο Μπρους είναι Αυστραλός; <AudioPlayer src="../assets/28-Lesson8-2.mp3" buttonText="28" /></span>
  </div>

  <div>
    <span>Exercise 14 <AudioPlayer src="../assets/29-Lesson8-3.mp3" buttonText="29" /></span>
  </div>
